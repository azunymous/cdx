...
type DiffReply struct {
	...
	Committed string `protobuf:"bytes,1,opt,name=committed,proto3" json:"committed,omitempty"`
...
func (x *DiffReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *DiffReply) GetCommitted() string {
	if x != nil {
		return x.Committed
	}
	return ""
...
func (x *DiffReply) GetDiff() string {
	if x != nil {
		return x.Diff
	}
	return ""
...
var file_watch_diff_diff_proto_rawDesc = []byte{
	...
	,
}
...
type DiffClient interface {
	// Sends a greeting
	SendDiff(ctx context.Context, in *DiffRequest, opts ...grpc.CallOption) (*DiffReply, error)
}
...
func (c *diffClient) SendDiff(ctx context.Context, in *DiffRequest, opts ...grpc.CallOption) (*DiffReply, error) {
	out := new(DiffReply)
...
type DiffServer interface {
	// Sends a greeting
	SendDiff(context.Context, *DiffRequest) (*DiffReply, error)
}
...
func (*UnimplementedDiffServer) SendDiff(context.Context, *DiffRequest) (*DiffReply, error) {
