...
type DiffCommits struct {
	...
	Name      string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	Commits   []byte `protobuf:"bytes,2,opt,name=commits,proto3" json:"commits,omitempty"`
...
func (x *DiffCommits) GetCommits() []byte {
	if x != nil {
		return x.Commits
	}
	return nil
...
var file_watch_diff_diff_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x73, 0x12, 0x12, 0x0a,
