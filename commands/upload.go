...
func addUpload(topLevel *cobra.Command) {
	...
	uploadCmd := &cobra.Command{
		...
		Short: "[ALPHA] Upload uploads your workspace's git commits changed from origin/master",
		Long: `The upload command connects to a server to upload your workspace patch under a specified name
`,
